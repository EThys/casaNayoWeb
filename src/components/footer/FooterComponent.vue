  ...
  <footer class="bg-gray-900 text-white pt-16 pb-10 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
        ...
        <!-- Liens rapides -->
        <div>
          <h3 class="text-lg font-semibold mb-5">Support</h3>
          <ul class="space-y-3">
            <li>
              <a
                href="#"
        ...
        <!-- Contact -->
        <div>
          <h3 class="text-lg font-semibold mb-5">Contact</h3>
          <ul class="space-y-4">
            <li class="flex items-start group">
              <div class="bg-gray-800 p-1.5 rounded-lg mr-3 group-hover:bg-blue-600 transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
